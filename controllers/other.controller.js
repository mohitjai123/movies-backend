...
const generateCrud = (Model) => ({
  ...
  getAll: (req, res) => Model.find().then(d => res.json(d)),
...
module.exports = {
  ...
  languageController: generateCrud(require('../models/language.model')),
  genresController: generateCrud(require('../models/genres.model'))
};
